...
try {
    // Consulta buscando en las columnas principales
    $sql = "SELECT * FROM soportes WHERE 
            area LIKE :q OR 
            tipo_equipo LIKE :q OR
            folio LIKE :q OR
            n_inventario LIKE :q
            ORDER BY id DESC";
...
<head>
    ...
    <title>Resultados de Búsqueda - SOPORTICS</title>
	<link rel="icon" href="images/icono.png">
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/dashboard.css" rel="stylesheet">
    <style>
        .thead-success { background-color: #00CC07; color: white; }
        .letra { font-weight: bold; }
  ...
  <symbol id="clipboard2" viewBox="0 0 16 16">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">
            <?php echo isset($_SESSION['usuarioactual']) ? $_SESSION['usuarioactual'] : 'Usuario'; ?>
        </a>
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="principal.php">SOPORTICS V.1.0</a>
    </header>
        ...
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
			  ...
			  <svg class="bi"><use xlink:href="#list"/></svg>
                Listado Mttos.
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 active" href="#" data-bs-toggle="modal" data-bs-target="#modalBuscar">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="listado.php" class="btn btn-sm btn-outline-secondary">Volver al Listado General</a>
                </div>
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            <?php if(!empty($resultados)): ?>
                                ...
                                <tr>
                                    <td><?php echo htmlspecialchars($row['folio'] ?? $row['id']); ?></td>
                                    <td><?php echo htmlspecialchars($row['area'] ?? ''); ?></td>
                                    <td><?php echo htmlspecialchars($row['tipo_equipo'] ?? ''); ?></td>
                                    <td><?php echo htmlspecialchars($row['n_inventario'] ?? ''); ?></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="editar.php?ref=<?php echo $row['id']; ?>" class="btn btn-sm btn-editar">Editar</a>
                                            <a href="registro.php?ref=<?php echo $row['id']; ?>" class="btn btn-sm btn-imprimir" target="_blank">Imprimir</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="text-center py-4">No se encontraron coincidencias.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nueva Búsqueda</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="buscar.php" method="GET">
                    <div class="modal-body">
                        <input type="text" class="form-control" name="q" placeholder="Buscar por área, folio o equipo..." required>
                    </div>
