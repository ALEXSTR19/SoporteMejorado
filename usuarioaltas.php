...
{ 
    ...
    if ($existe > 0) {
        // Agregar sufijo único para evitar duplicado
    ...
    $sql_query = "insert into soportes(folio,fecha,hora,usuario,tipo_equipo,marca,modelo,serie,n_inventario,area,tipo_mantto,usuario_equipo,usuario_reporte,contacto,falla,asignado,token,estado) values ('$folio_generado','$_POST[fechareg]','$_POST[hora]','$_POST[usuario]','$_POST[tipo_equipo]','$_POST[marca]','$_POST[modelo]','$_POST[serie]','$_POST[n_inventario]','$_POST[area]','$_POST[tipo_mantto]','$_POST[usuario_equipo]','$_POST[usuario_reporte]','$_POST[movil]','$_POST[falla]','$_POST[usuarioa]','$token_guardar','1')";
...
<div class="container-fluid">
 ...
 <form class="row g-3" action="usuarioaltas.php" method="POST" autocomplete="off">
    	  <?php
    	       	if (isset ($msg))
...
function guardarOpcion() {
    ...
    .then(function(data) {
        if (data.success) {
            ...
            selectElement.value = data.valor; // Seleccionar la nueva opción
