...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
			...
			<li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="#" data-bs-toggle="modal" data-bs-target="#modalRU">
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
		<h1 class="h2">Alta de Usuarios del Departamento de TI</h1>
    </div>
	<?php
	if (isset($_REQUEST['registrar']))
	{
		$departamento = "Tecnologías de Información y la Comunicación";
		$clave = md5($_GET['clave']);
		$id = $_GET['id'];
		$nombre = $_GET['nombre'];
		$estado = $_GET['estado'];
		$correo = isset($_GET['correo']) ? $_GET['correo'] : '';
		$sql_query = "insert into usuarios (idusuario,nombre,clave,departamento,estado,correo) values ('$id','$nombre','$clave','$departamento','$estado','$correo')";
	...
	{
		$msg="Error no se agregaron los datos";
		echo "<tr>
				<td colspan='8' class='text-center py-4'>
					<div class='alert alert-info mb-0'>
					<center>$msg</center>
