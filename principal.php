...
<div class="container-fluid">
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel"><? echo $_SESSION['usuarioactual'];?></h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
			...
			<li class="nav-item"><a class="nav-link d-flex align-items-center gap-2" href="inventario.php"><svg class="bi"><use xlink:href="#cart"/></svg>Control e inventario</a></li>
            </ul>
          <hr class="my-3">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 " >
        <div class="bordo">
       <center><img src="log1.png" width="40%" height="30%"><center>
        </div>   
    </main>
