...
<style>
body{background:#f4f7fb}.inventory-hero{background:linear-gradient(125deg,#123c69,#176b87);color:#fff;border-radius:1rem;padding:1.6rem}.metric{border:0;border-radius:1rem;box-shadow:0 5px 20px rgba(21,49,78,.08)}.metric .number{font-size:1.8rem;font-weight:700}.panel{border:0;border-radius:1rem;box-shadow:0 5px 20px rgba(21,49,78,.08)}.stock-low{background:#fff3cd!important}.table td,.table th{vertical-align:middle}.brand-dot{width:10px;height:10px;background:#43d9a3;border-radius:50%;display:inline-block}.nav-pills .nav-link.active{background:#176b87}.item-row{border:1px solid #dee2e6;border-radius:.7rem;padding:.75rem;margin-bottom:.6rem;background:#fff}@media (max-width:767.98px){#modalEditar .modal-body{overflow-y:scroll;-webkit-overflow-scrolling:touch}}@media print{.no-print{display:none!important}body{background:#fff}.panel{box-shadow:none}}
</style></head><body>
